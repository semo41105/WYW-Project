...
CREATE TABLE USERFOLLOW(
   LOGINUSER VARCHAR2(500), 
   FOLLOWUSER VARCHAR2(500),
   CONSTRAINT FOLLOW_PK PRIMARY KEY(LOGINUSER,FOLLOWUSER),
   CONSTRAINT LOGINUSER_FK FOREIGN KEY(LOGINUSER) REFERENCES USERDATA(USERID),
...
DROP TABLE USERFOLLOW CASCADE CONSTRAINTS;
DROP SEQUENCE GROUPNOSQ;
