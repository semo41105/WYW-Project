...
INSERT INTO USERDATA VALUES(
USERNOSQ.NEXTVAL, 'MANAGER', 'MANAGER123', '매니저', '서울시 마포구', '010-1234-7890', 'MANAGER123@NAVER.COM', 'Y', 
'MANAGER', 0
);
...
BOARDNOSQ.NEXTVAL, GROUPNOSQ.NEXTVAL, 1, 'TEST 1번째', 'TEST 중입니다. ADMIN이 쓴 공지 1번째', '1', NULL, NULL, 0, SYSDATE
);
INSERT INTO USERCONTENT VALUES(
BOARDNOSQ.NEXTVAL, GROUPNOSQ.NEXTVAL, 1, 'TEST 2번째', 'TEST 중입니다. MANAGER가 쓴 공지 2번째', '2', NULL, NULL, 0, SYSDATE
);
INSERT INTO USERCONTENT VALUES(
BOARDNOSQ.NEXTVAL, GROUPNOSQ.NEXTVAL, 1, 'TEST 3번째', 'TEST 중입니다. 공지 아닌 일반 게시글 1번째', '3', NULL, NULL, 0, SYSDATE
);
