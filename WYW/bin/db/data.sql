...
SELECT * FROM USERCONTENT  JOIN USERDATA ON(USERCONTENT.USERIDNO = USERDATA.USERNO) 
...
SELECT * FROM USERDATA WHERE USERENABLED='Y' ORDER BY USERNO DESC ;
...
USERNOSQ.NEXTVAL, 'ADMIN', 'ADMIN123', '관리자', '서울특별시', '010-1234-1234', 'ADMIN123@NAVER.COM', 'Y', 'MANAGER', 0);

INSERT INTO USERDATA VALUES(
USERNOSQ.NEXTVAL, 'ADMIN1', 'ADMIN123', '관리자1', '경기도', '010-1234-4321', 'ADMIN1@GAMIL.COM', 'Y', 
'ADMIN', 0
);


INSERT INTO USERDATA VALUES(
USERNOSQ.NEXTVAL, 'USER1', 'USER123', '유저1', '경기도', '010-5674-4321', 'USER1@GMAIL.COM', 'Y', 
'USER', 0
);
